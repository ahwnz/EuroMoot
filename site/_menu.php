<nav id="menu" class="hide-for-small-only">
  <div class="grid-x grid-padding-x grid-padding-y">
    ...
    <div class="small-12 medium-6 large-4 cell">
      <a class="linkbox" href="<?=$prefix?>/when.php">
        When is Moot? <span class="pull-right"><i class="fa fa-clock-o"></i></span>
      </a>
    </div>
    <div class="small-12 medium-6 large-4 cell">
      <a class="linkbox"  href="<?=$prefix?>/where.php">
    ...
    <div class="small-12 medium-6 large-4 cell">
      <a class="linkbox" href="https://www.regonline.com/registration/checkin.aspx?EventId=1980399" target="_blank" title="Register for Moot">
        Registration <span class="pull-right"><i class="fa fa-user-plus"></i></span>
      </a>
    </div>
    <div class="small-12 medium-6 large-4 cell">
...
<nav id="mobile-menu" class="show-for-small-only">
  <a id="toggle-menu">
    <i class="fa fa-bars"></i>
    <i class="fa fa-times"></i>
  </a>
  <div class="title">EuroMoot</div>
  <ul id="menu-dropdown">
    <li>
      <a class="linkbox" href="<?=$prefix?>/what.php">
        What is Moot? <span class="pull-right"><i class="fa fa-question fa-fw"></i></span>
      </a>
    </li>
    <li>
      <a class="linkbox" href="<?=$prefix?>/when.php">
        When is Moot? <span class="pull-right"><i class="fa fa-clock-o fa-fw"></i></span>
      </a>
    </li>
    <li>
      <a class="linkbox"  href="<?=$prefix?>/where.php">
    ...
    <li>
      <a class="linkbox" href="https://www.regonline.com/registration/checkin.aspx?EventId=1980399" target="_blank" title="Register for Moot">
        Registration <span class="pull-right"><i class="fa fa-user-plus fa-fw"></i></span>
      </a>
    </li>
    <li>
      <a class="linkbox" href="https://www.facebook.com/EuroMoot2018/" target="_blank" title="EuroMoot on Facebook">
        Facebook <span class="pull-right"><i class="fa fa-facebook fa-fw"></i></span>
      </a>
    </li>
    <li>
      <a class="linkbox" href="https://www.instagram.com/EuroMoot2018/" target="_blank" title="EuroMoot on Instagram">
        Instagram <span class="pull-right"><i class="fa fa-instagram fa-fw"></i></span>
      </a>
    </li>
  </ul>
</nav>
...
<?php if($page_path == "") { ?>
<div class="logo-container show-for-small-only">
  <div id="logo">
