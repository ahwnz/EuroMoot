...
<body>
  ...
  <div class="box-set">
    ...
    <div class="box preview">
      ...
      <div class="box-full">What?</div>
    </div>
    <div class="box preview">
      <div class="box-title">When?
      ...
      <div class="box-full">When</div>
    </div>
    <div class="box preview">
      <div class="box-title">Where?
    ...
    <div class="box preview">
      ...
      <div class="box-full">Themes</div>
    </div>
    <div class="box preview">
      <div class="box-title">Tours
      ...
      <div class="box-full">Tours</div>
    </div>
    <div class="box preview">
      <div class="box-title">Merchandise
    ...
    <div class="box preview">
      <div class="box-title">Contact Us
